...
echo !YELLOW!Running UI Manager Functional Tests...!NC!
...
if "%BUILD_TYPE%"=="Debug" (
    set TEST_EXECUTABLE=..\..\bin\debug\ui_manager_functional_tests.exe
) else (
    set TEST_EXECUTABLE=..\..\bin\release\ui_manager_functional_tests.exe
)
...
set OUTPUT_FILE=..\..\test_results\ui_manager_functional_tests_output.txt
...
if %ERRORLEVEL% equ 0 (
    ...
    if !TEST_RESULT! neq 0 (
        ...
        echo !GREEN!✅ All UI Manager Functional tests passed!!NC!
        exit /b 0
    )
)
