...
echo !YELLOW!Running Buffer Reuse Tests...!NC!
...
if "%BUILD_TYPE%"=="Debug" (
    set TEST_EXECUTABLE=..\..\bin\debug\buffer_reuse_tests.exe
) else (
    set TEST_EXECUTABLE=..\..\bin\release\buffer_reuse_tests.exe
)
...
set OUTPUT_FILE=..\..\test_results\buffer_reuse_tests_output.txt
...
if %ERRORLEVEL% equ 0 (
    ...
    if !TEST_RESULT! neq 0 (
        ...
        echo !GREEN!✅ All Buffer Reuse tests passed!!NC!
        exit /b 0
    )
)
