...
echo !YELLOW!Running SIMD Correctness Tests...!NC!
...
if "%BUILD_TYPE%"=="Debug" (
    set TEST_EXECUTABLE=..\..\bin\debug\simd_correctness_tests.exe
) else (
    set TEST_EXECUTABLE=..\..\bin\release\simd_correctness_tests.exe
)
...
set OUTPUT_FILE=..\..\test_results\simd_correctness_tests_output.txt
...
if %ERRORLEVEL% equ 0 (
    ...
    if !TEST_RESULT! neq 0 (
        ...
        echo !GREEN!✅ All SIMD Correctness tests passed!!NC!
        exit /b 0
    )
)
