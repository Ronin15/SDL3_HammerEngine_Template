@echo off
:: Script to run the Camera Tests
...
echo !YELLOW!Running Camera Tests...!NC!
...
if "%BUILD_TYPE%"=="Debug" (
    set TEST_EXECUTABLE=..\..\bin\debug\camera_tests.exe
) else (
    set TEST_EXECUTABLE=..\..\bin\release\camera_tests.exe
)
...
set OUTPUT_FILE=..\..\test_results\camera_tests_output.txt
...
if %ERRORLEVEL% equ 0 (
    ...
    if !TEST_RESULT! neq 0 (
        ...
        echo !GREEN!✅ All Camera tests passed!!NC!
        exit /b 0
    )
)
