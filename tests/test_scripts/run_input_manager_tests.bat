...
echo !YELLOW!Running Input Manager Tests...!NC!
...
if "%BUILD_TYPE%"=="Debug" (
    set TEST_EXECUTABLE=..\..\bin\debug\input_manager_tests.exe
) else (
    set TEST_EXECUTABLE=..\..\bin\release\input_manager_tests.exe
)
...
set OUTPUT_FILE=..\..\test_results\input_manager_tests_output.txt
...
if %ERRORLEVEL% equ 0 (
    ...
    if !TEST_RESULT! neq 0 (
        ...
        echo !GREEN!✅ All Input Manager tests passed!!NC!
        exit /b 0
    )
)
