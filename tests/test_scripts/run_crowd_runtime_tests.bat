@echo off
rem Crowd Runtime Test Runner (AI crowd behavior)
...
if /i "%~1"=="--help" (
    echo !BLUE!Crowd Runtime Test Runner!NC!
    echo Usage: run_crowd_runtime_tests.bat [options]
    echo.
    echo Options:
...
echo !BLUE!Running Crowd Runtime Tests!NC!

rem Track overall result
set OVERALL_RESULT=0

call :run_single_test crowd_runtime_tests
...
if !OVERALL_RESULT! neq 0 (
    echo.
    echo !RED!Some Crowd Runtime tests failed!!NC!
    exit /b 1
) else (
    echo.
    echo !GREEN!All Crowd Runtime tests completed successfully!!NC!
    echo !GREEN!  crowd_runtime_tests!NC!
    exit /b 0
)
