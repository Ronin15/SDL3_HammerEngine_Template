...
echo !YELLOW!Running Loading State Tests...!NC!
...
if "%BUILD_TYPE%"=="Debug" (
    set TEST_EXECUTABLE=..\..\bin\debug\loading_state_tests.exe
) else (
    set TEST_EXECUTABLE=..\..\bin\release\loading_state_tests.exe
)
...
set OUTPUT_FILE=..\..\test_results\loading_state_tests_output.txt
...
if %ERRORLEVEL% equ 0 (
    ...
    if !TEST_RESULT! neq 0 (
        ...
        echo !GREEN!✅ All Loading State tests passed!!NC!
        exit /b 0
    )
)
