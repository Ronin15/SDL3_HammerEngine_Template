...
echo -e "${YELLOW}Running Camera Tests...${NC}"
...
if [ "$BUILD_TYPE" = "Debug" ]; then
  TEST_EXECUTABLE="$PROJECT_ROOT/bin/debug/camera_tests"
else
  TEST_EXECUTABLE="$PROJECT_ROOT/bin/release/camera_tests"
fi
...
OUTPUT_FILE="$PROJECT_ROOT/test_results/camera_tests_output.txt"
