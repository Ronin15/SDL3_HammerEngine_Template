...
This Skill is **critical** for SDL3 VoidLight-Framework's performance requirements. The engine must maintain 10,000+ entity support at 60+ FPS with minimal CPU usage. This Skill detects performance regressions before they reach production.
...
# Example: cd /path/to/SDL3_VoidLight-Framework_Template && export PROJECT_ROOT=$(pwd)
