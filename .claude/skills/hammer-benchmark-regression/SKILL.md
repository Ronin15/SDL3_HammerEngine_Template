...
Located in `/home/RoninXV/projects/cpp_projects/SDL3_HammerEngine_Template/`
...
```
/home/RoninXV/projects/cpp_projects/SDL3_HammerEngine_Template/test_results/baseline/
...
if [ ! -d "test_results/baseline/" ]; then
...
**Baseline:** `test_results/baseline/*.txt`
**Current Results:** `test_results/*/performance_metrics.txt`
**Callgrind Reports:** `test_results/valgrind/callgrind/` (if available)
**Full Report:** `test_results/regression_reports/regression_YYYY-MM-DD.md`
...
**Report saved to:** test_results/regression_reports/regression_YYYY-MM-DD.md
```
...
Full Report: test_results/regression_reports/regression_2025-01-15.md
```
...
```bash
# After validating improvements, update baseline
cp test_results/*/performance_metrics.txt test_results/baseline/
echo "Baseline updated: $(date)" > test_results/baseline/baseline_date.txt
```
