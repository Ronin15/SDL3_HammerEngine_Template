...
This Skill automates the creation of standardized test infrastructure for new SDL3 VoidLight-Framework systems. It generates all necessary files following the project's established patterns.
...
**Generated by:** voidlight-test-suite-generator Skill
