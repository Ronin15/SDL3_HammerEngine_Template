...
#define PROJ_CRITICAL(msg) HAMMER_CRITICAL("Projectile", msg)
#define PROJ_ERROR(msg) HAMMER_ERROR("Projectile", msg)
#define PROJ_WARN(msg) HAMMER_WARN("Projectile", msg)
#define PROJ_INFO(msg) HAMMER_INFO("Projectile", msg)
#define PROJ_DEBUG(msg) HAMMER_DEBUG("Projectile", msg)
