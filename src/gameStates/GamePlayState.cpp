...
bool GamePlayState::exit() {
  ...
  if (!m_transitioningToPause) {
    ...
    std::cout << "Hammer Game Engine - reset player pointer to null, not going to pause\n";
  } else {
    std::cout << "Hammer Game Engine - Not clearing player and textures, transitioning to pause\n";
  }
